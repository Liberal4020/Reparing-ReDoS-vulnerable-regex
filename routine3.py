...
fr = open('./REMEDY-SP2022/testcases/sample1.txt', 'r')
...
while True:
  ...
  result = subprocess.run(["timeout","100000000000000000000000000000000","java","-jar","REMEDY-SP2022.jar","repair","testcases/sample1.txt"], cwd="./REMEDY-SP2022", stdout=subprocess.PIPE, text=True)
  ...
  if str_list[0] == "Equivalent\n":
    ...
    with open('./REMEDY-SP2022/testcases/sample1.txt', 'r+') as file:
      line = file.readlines()
      if str_list[0] != "\n\n":
